...
SUPPORTED_LANGUAGES: Dict[str, LanguageSpec] = {
    ...
    "bn": LanguageSpec(code="bn", name="Bengali", native_name="বাংলা", rate_type="syllables", base_rate_per_second=5.2, words_per_minute=140, pause_comma_ms=200, pause_period_ms=400),
    "ta": LanguageSpec(code="ta", name="Tamil", native_name="தமிழ்", rate_type="syllables", base_rate_per_second=5.4, words_per_minute=145, pause_comma_ms=200, pause_period_ms=400),
    "te": LanguageSpec(code="te", name="Telugu", native_name="తెలుగు", rate_type="syllables", base_rate_per_second=5.5, words_per_minute=145, pause_comma_ms=200, pause_period_ms=400),
    "mr": LanguageSpec(code="mr", name="Marathi", native_name="मराठी", rate_type="syllables", base_rate_per_second=5.4, words_per_minute=140, pause_comma_ms=200, pause_period_ms=400),
    "gu": LanguageSpec(code="gu", name="Gujarati", native_name="ગુજરાતી", rate_type="syllables", base_rate_per_second=5.2, words_per_minute=140, pause_comma_ms=200, pause_period_ms=400),
    "kn": LanguageSpec(code="kn", name="Kannada", native_name="ಕನ್ನಡ", rate_type="syllables", base_rate_per_second=5.3, words_per_minute=140, pause_comma_ms=200, pause_period_ms=400),
    "ml": LanguageSpec(code="ml", name="Malayalam", native_name="മലയാളം", rate_type="syllables", base_rate_per_second=5.3, words_per_minute=140, pause_comma_ms=200, pause_period_ms=400),
    "pa": LanguageSpec(code="pa", name="Punjabi", native_name="ਪੰਜਾਬੀ", rate_type="syllables", base_rate_per_second=5.4, words_per_minute=145, pause_comma_ms=200, pause_period_ms=400),
    "ur": LanguageSpec(code="ur", name="Urdu", native_name="اردو", rate_type="syllables", base_rate_per_second=5.2, words_per_minute=140, pause_comma_ms=200, pause_period_ms=400),
...
FEW_SHOT_TRANSLATION_EXAMPLES = {
    ...
    "en-hi": [
        ...
        {"src": "today.", "tgt": "आज।", "note": "Short closing fragment — keep concise"},
